...
<script src="${pageContext.request.contextPath}/resources/js/dispatchClear.js" type="text/javascript"></script>
			...
			<div class="tab-full-wrapper-2">
				<div class="all-invoice-full-wrapper-controls">
					...
					<div class="act-button-controls">
						<button type="submit" id="dispatchClearGo" class="blue-button">Go</button>
					</div>

					<div class="act-button-controls">
						<button type="submit" id="dispatchClearExport" class="green-center">Export To Excel</button>
					</div>							
				</div>						
				<div class="sales-suumary-table-box">
					<h3>Dispatch Clear Report</h3>
					<fieldset>
						<div class="all-invoice-full-wrapper-controls">
						...
						<div class="sales-sum-table-wrapper-box">
							<div class="sales-sum-table-wrapper">
								<table class="act-table" id="dispatchedInvoicesTable">
									<thead>
										<tr>
											<th>Call Taker ID</th>
											<th>Dispatch ID</th>
									...
									<tbody>
									<c:forEach items="${dispatchedInvoices}" var="dispatchedInvoices">
										<tr>										
											<td><c:out value="${dispatchedInvoices.callTakerId}"/></td>
											<td><c:out value="${dispatchedInvoices.dispatchId}"/></td>
											<td><c:out value="${dispatchedInvoices.driverId}"/></td>
											<td><c:out value="${dispatchedInvoices.noOwnerInfo}"/></td>
											<td><c:out value="${dispatchedInvoices.poRequired}"/></td>											
										</tr>
									</c:forEach>
										<tr>
											<td></td>
                            				...
                            				<td></td>
                            				<td></td>
                            				<td><div class="act-billing"><label>Total Invoices: ${totalInvoices}</label></div></td>                             				
                             		</tr>
									</tbody>
								</table>
							</div>
