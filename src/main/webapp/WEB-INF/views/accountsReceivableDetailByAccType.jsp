...
<script src="${pageContext.request.contextPath}/resources/js/accountsReceivableDetailByAccType.js" type="text/javascript"></script>
		...
		<div class="container">			
			...
			<div class="tab-full-wrapper-2">
				<div class="all-invoice-full-wrapper-controls">
					<div class="act-search-control">
						<div class="act-select-control">
	                		<select class="select-3" id="selectAccountType">
						...
						<div class="act-button-controls">
							<button type="submit" id="accountsReceivableDetailByAccTypeGo" class="blue-button">Go</button>
							<button type="submit" id="accountsReceivableDetailByAccTypeExport" class="green-center">Export To Excel</button>
				...
				<div class="sales-suumary-table-box">
					<h3 align="center"><font color="green">Accounts Receivable Detail By Account Type Report</font></h3>
					<fieldset>											
						<div class="all-invoice-full-wrapper-controls">
							<h5>Account Type: ${accType}</h5>
						...
						<div class="sales-sum-table-wrapper-box">
							<div class="sales-sum-table-wrapper">
								...
								<BR>
								<table class="act-table" id="accountsReceivableDetailByAccTypeTable">
									<thead>
										<tr>
											<th>Account</th>
											<th># Unpaid</th>
									...
									<tbody>
									<c:forEach items="${accountsReceivableDetailByAccType}" var="accountsReceivableDetailByAccType">
										<tr>										
											<td><c:out value="${accountsReceivableDetailByAccType.account}"/></td>
											<td><c:out value="${accountsReceivableDetailByAccType.unPaid}"/></td>
											<td><c:out value="${accountsReceivableDetailByAccType.balance}"/></td>
										</tr>
									</c:forEach>										
									</tbody>
								</table>
