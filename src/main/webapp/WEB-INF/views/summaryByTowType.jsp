...
<title>All City Towing - Summaries - Summary By Tow Type</title>
...
<script src="${pageContext.request.contextPath}/resources/js/summaryByTowType.js" type="text/javascript"></script>
			...
			<div class="tab-full-wrapper-2">
				<div class="all-invoice-full-wrapper-controls">
					...
					<div class="act-button-controls">
						<button type="submit" id="summaryByTowTypeGo" class="blue-button">Go</button>
					</div>

					<div class="act-button-controls">
						<button type="submit" id="summaryByTowTypeExport" class="green-center">Export To Excel</button>
					</div>							
				</div>						
				<div class="sales-suumary-table-box">
					<h3>Sales Summary by Tow Type</h3>
					<fieldset>
						<div class="all-invoice-full-wrapper-controls">
						...
						<div class="sales-sum-table-wrapper-box">
							<div class="sales-sum-table-wrapper">
								<table class="act-table" id="summaryByTowType">
									<thead>
										<tr>
											<th>Type</th>
									...
									<tbody>
									<c:forEach items="${summaryByTowTypeList}" var="towTypeDetails">
										<tr>										
											<td><c:out value="${towTypeDetails.type}"/></td>
											<td><c:out value="${towTypeDetails.noOfTows}"/></td>
											<td>$<c:out value="${towTypeDetails.totalCharges}"/></td>
											<td><c:out value="${towTypeDetails.use}"/>%</td>
											<td><c:out value="${towTypeDetails.chargesPerTow}"/></td>
										</tr>
									</c:forEach>
									<tr>
