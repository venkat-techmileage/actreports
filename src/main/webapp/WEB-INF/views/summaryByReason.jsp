...
<title>All City Towing - Summaries - Summary By Reason</title>
...
<script src="${pageContext.request.contextPath}/resources/js/summaryByReason.js" type="text/javascript"></script>
			...
			<div class="tab-full-wrapper-2">
				<div class="all-invoice-full-wrapper-controls">
					...
					<div class="act-button-controls">
						<button type="submit" id="summaryByReasonGo" class="blue-button">Go</button>
					</div>

					<div class="act-button-controls">
						<button type="submit" id="summaryByReasonExport" class="green-center">Export To Excel</button>
					</div>							
				</div>						
				<div class="sales-suumary-table-box">
					<h3>Sales Summary by Reason Code</h3>
					<fieldset>
						<div class="all-invoice-full-wrapper-controls">
						...
						<div class="sales-sum-table-wrapper-box">
							<div class="sales-sum-table-wrapper">
								<table class="act-table" id="summaryByReason">
									<thead>
										<tr>
											<th>Reason</th>
									...
									<tbody>
									<c:forEach items="${summaryByReasonList}" var="reasonCodeDetails">
										<tr>										
											<td><c:out value="${reasonCodeDetails.reason}"/></td>
											<td><c:out value="${reasonCodeDetails.noOfTows}"/></td>
											<td>$<c:out value="${reasonCodeDetails.totalCharges}"/></td>
											<td><c:out value="${reasonCodeDetails.use}"/>%</td>
											<td><c:out value="${reasonCodeDetails.chargesPerTow}"/></td>
										</tr>
									</c:forEach>
									<tr>
