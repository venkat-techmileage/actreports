...
<title>All City Towing - Summaries - Summary By Driver</title>
...
<script src="${pageContext.request.contextPath}/resources/js/summaryByDriver.js" type="text/javascript"></script>
			...
			<div class="tab-full-wrapper-2">
				<div class="all-invoice-full-wrapper-controls">
					...
					<div class="act-button-controls">
						<button type="submit" id="summaryByDriverGo" class="blue-button">Go</button>
					</div>

					<div class="act-button-controls">
						<button type="submit" id="summaryByDriverExport" class="green-center">Export To Excel</button>
					</div>							
				</div>						
				<div class="sales-suumary-table-box">
					<h3>Sales Summary by Driver</h3>
					<fieldset>
						<div class="all-invoice-full-wrapper-controls">
						...
						<div class="sales-sum-table-wrapper-box">
							<div class="sales-sum-table-wrapper">
								<table class="act-table" id="summaryByDriver">
									<thead>
										<tr>
											<th>Driver Id</th>
											<th>Driver Name</th>
									...
									<tbody>
									<c:forEach items="${summaryByDriverList}" var="driverDetails">
										<tr>										
											<td><c:out value="${driverDetails.driverId}"/></td>
											<td><c:out value="${driverDetails.driverName}"/></td>
											<td><c:out value="${driverDetails.noOfTows}"/></td>
											<td>$<c:out value="${driverDetails.totalCharges}"/></td>
											<td><c:out value="${driverDetails.use}"/>%</td>
											<td><c:out value="${driverDetails.chargesPerTow}"/></td>
										</tr>
									</c:forEach>
									<tr>
										<td></td>
